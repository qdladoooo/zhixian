...
@section('content')
    <form class="form-horizontal" method="post" action="/disease">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="is_heathy" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="tumour_location" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="inflammation" class="form-control">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <select name="autoimmune" class="form-control">
